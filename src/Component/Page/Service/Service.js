        ...
        <div> 
            ...
            <div class="relative min-h-screen flex flex-col justify-center bg-slate-900 overflow-hidden" style={{ backgroundImage: `url(" ")`  }}>
                ...
                <div class="w-full max-w-5xl mx-auto px-4 md:px-6 py-12">
                        ...
                        <div class="max-w-lg mx-auto relative">
                            ...
                            ">
                                ...
                                <header class="mb-2 p-2">
                                     ...
                                     <div class="text-sm leading-relaxed text-slate-500 space-y-4   mb-2">
                                         <div className='loll  '  style={{"height":"150px"}}>
 
                                         </div>
                                          
                                     </div>
                                    <footer class="text-right">
                                        <h1 className='text-2xl  text-bold text-start text-white'>UI-UX</h1> 
                                        <p  className='text-xs  text-bold text-start text-white'>Everyone has the right to freedom of thought, conscience and religionEveryone has the right to freedom of thought, conscience and religion</p>
                                    </footer>
                                </article>
                            </div>
                            ...
                            ">
                                ...
                                <header class="mb-2 p-2">
                                    ...
                                    <footer class="text-right">
                                        <h1 className='text-2xl  text-bold text-start text-white'>ERP</h1> 
                                        <p  className='text-xs  text-bold text-start text-white'>Everyone has the right to freedom of thought, conscience and religionEveryone has the right to freedom of thought, conscience and religion</p>
                                    </footer>
                                </article>
                            </div>
                            ...
                            > 
                                <article class="bg-white p-6 rounded-lg shadow-2xl bg-cover bg-center  bg-auto bg-no-repeat" style={{ backgroundImage: `url("https://i.ibb.co/VSKXDYh/Rectangle-6.png")`  }}>
                                    ...
                                    <footer class="text-right">
                                        <h1 className='text-2xl  text-bold text-start text-white'>OTA</h1> 
                                        <p  className='text-xs  text-bold text-start text-white'>Everyone has the right to freedom of thought, conscience and religionEveryone has the right to freedom of thought, conscience and religion</p>
                                    </footer>
                                </article>
                            </div>
                            ...
                            ">
                                ...
                                <header class="mb-2 p-2">
                                    ...
                                    <footer class="text-right">
                                        <h1 className='text-2xl  text-bold text-start text-white'>Web Development</h1> 
                                        <p  className='text-xs  text-bold text-start text-white'>Everyone has the right to freedom of thought, conscience and religionEveryone has the right to freedom of thought, conscience and religion</p>
                                    </footer>
                                </article>
                            </div>  
                    ...
                    <div className='p-2 m-2'>
                        <input type="radio" name="radio-1" class="radio radio-gray-50 m-1 p-1"  /> 
                        <input type="checkbox" class="toggle toggle-accent m-1 p-1"   />
                        <input type="radio" name="radio-1" class="radio p-1 m-1"  />
                    </div>
